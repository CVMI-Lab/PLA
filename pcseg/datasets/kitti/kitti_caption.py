...
class KittiDatasetCaption(KittiDataset):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--func', type=str, default='create_kitti_caption_idx',
                        choices=['create_kitti_caption_idx',
                                 'create_kitti_caption_idx_detic_crop',
                                 'create_kitti_caption_idx_basic_crop',
                                 'create_kitti_caption_idx_detic_crop_caption'],
                        help='')
    ...
    if args.func == 'create_kitti_caption_idx':
        """
        python -m pcseg.datasets.kitti.kitti_caption --func create_kitti_caption_idx \
        --cfg_file tools/cfgs/dataset_configs/kitti_dataset_multimodal.yaml \
        --model_cfg tools/cfgs/kitti_models/sparseunet_debug_image.yaml \
        --version v1.0-mini
        """
        dataset.create_caption_idx(args.workers)
    elif args.func == 'create_kitti_caption_idx_detic_crop':
        """
        python -m pcseg.datasets.kitti.kitti_caption --func create_kitti_caption_idx_detic_crop \
        --cfg_file tools/cfgs/dataset_configs/kitti_dataset_multimodal.yaml \
        --model_cfg tools/cfgs/kitti_models/sparseunet_debug_image.yaml --version v1.0-mini --workers 4 \
        --detic_info_path ../Detic/kitti_v1.0-mini_detic_pred_results.pkl \
        --save_path data/kitti/v1.0-mini/kitti_caption_idx_detic_crop.pkl
        """
